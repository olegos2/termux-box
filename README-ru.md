...
* Экспериментальный скрипт `wine-tweaks`, который автоматически устанавливает загруженный wine, кастомизирующий его для лучшей скорости TFM и уменьшенного размера
